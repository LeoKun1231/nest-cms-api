...
export class ChangeGoodsInfoAddressType1699938375567
	implements MigrationInterface
{
	name = "ChangeGoodsInfoAddressType1699938375567";
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
		await queryRunner.query(`
            ALTER TABLE \`goods_info\` DROP COLUMN \`address\`
        `);
		await queryRunner.query(`
            ALTER TABLE \`goods_info\`
            ADD \`address\` varchar(255) NOT NULL COMMENT '商品地址'
        `);
		await queryRunner.query(`
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`
            ALTER TABLE \`goods_info\`
            ADD \`address\` int NOT NULL COMMENT '商品地址'
        `);
		await queryRunner.query(`
