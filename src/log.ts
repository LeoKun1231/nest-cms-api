...
import { LogEnum } from './shared/enums/log.enum';
...
export function setupLogger() {
  ...
  const timestamp = config[LogEnum.TIMESTAMP] === 'true';
  ...
  const consoleTransports = new Console({
    level: (config[LogEnum.LOG_LEVEL] as string) || 'info',
